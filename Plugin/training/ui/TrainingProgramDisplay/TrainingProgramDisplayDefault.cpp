#include "pch.h"
#include "TrainingProgramDisplayDefault.h"

namespace training
{
	void TrainingProgramDisplayDefault::renderOneFrame(const std::shared_ptr<GameWrapper>& gameWrapper, CanvasWrapper canvas, const TrainingProgramExecutionData& data)
	{
	...
	RenderInfo TrainingProgramDisplayDefault::getRenderInfo(const std::shared_ptr<GameWrapper>& gameWrapper) const
	{
	...
	void TrainingProgramDisplayDefault::drawPanelBackground(CanvasWrapper& canvas, const RenderInfo& renderInfo) const
	{
		// Background
	...
	void TrainingProgramDisplayDefault::drawProgramName(CanvasWrapper& canvas, const RenderInfo& renderInfo) const
	{
		// Program Name
	...
	void TrainingProgramDisplayDefault::drawTrainingStepNumber(CanvasWrapper& canvas, const RenderInfo& renderInfo) const
	{
	...
	void TrainingProgramDisplayDefault::drawRemainingStepTime(CanvasWrapper& canvas, const RenderInfo& renderInfo) const
	{
	...
	void TrainingProgramDisplayDefault::drawRemainingProgramTime(CanvasWrapper& canvas, const RenderInfo& renderInfo) const
	{
	...
	void TrainingProgramDisplayDefault::drawCenteredText(const std::string& text, CanvasWrapper& canvas, const RenderInfo& renderInfo, const std::shared_ptr<GameWrapper>& gameWrapper, float stringScale, float alpha) const
	{
	...
	void TrainingProgramDisplayDefault::drawTrainingProgramStepTransition(CanvasWrapper& canvas, const RenderInfo& renderInfo, const std::shared_ptr<GameWrapper>& gameWrapper) const
	{
	...
	void TrainingProgramDisplayDefault::drawTrainingProgramFinishedInfo(CanvasWrapper& canvas, const RenderInfo& renderInfo, const std::shared_ptr<GameWrapper>& gameWrapper) const
	{
