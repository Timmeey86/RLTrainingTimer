...
#include <core/training/application/TrainingProgramFlowReadModel.h>
...
namespace Ui
{
	...
	public:
		...
		inline void updateReadModel(Core::Training::Application::TrainingProgramFlowReadModel readModel)
		{
	...
	private:
		Core::Training::Application::TrainingProgramFlowReadModel _readModel; 
	};
}