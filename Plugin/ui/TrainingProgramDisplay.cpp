...
//	{
//		if (!_readModel.StoppingIsPossible)
//		{
...
//		auto topBorder = (int)(bottomBorder * 0.96f);
//		
...
//		auto shortenedName = _readModel.SelectedTrainingProgramName.substr(0, 40);
...
//		shortenedName = _readModel.CurrentTrainingStepName.substr(0, 50);
//		canvas.DrawString(
//			fmt::format("{} / {}: {}", _readModel.CurrentTrainingStepNumber + 1, _readModel.TrainingProgramEntries.size(), shortenedName),
...
//		const auto remainingStepTime = std::chrono::milliseconds(_readModel.TimeLeftInCurrentStep);
...
//		const auto remainingProgramTime = std::chrono::milliseconds(_readModel.TimeLeftInProgram);
